    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.1s">
            ...
            <div class="mt-2" style="font-size: 0.75rem;">
                <span class="text-success fw-bold">Current Month</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.2s">
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted small fw-bold text-uppercase">Days Late</span>
            </div>
            <h2 class="mb-0 fw-bold text-warning"><?= $attendanceStats['late'] ?? 0 ?></h2>
            <div class="mt-2" style="font-size: 0.75rem;">
                <span class="text-muted">Punctuality matter</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.3s">
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted small fw-bold text-uppercase">Days Absent</span>
            </div>
            <h2 class="mb-0 fw-bold text-danger"><?= $attendanceStats['absent'] ?? 0 ?></h2>
            <div class="mt-2" style="font-size: 0.75rem;">
                <span class="text-muted">Stay Consistent</span>
            </div>
        </div>
    </div>
