...
<?php if ($user): ?>
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <?php
            // Role specific settings for Leader/Permanent
            $themeColor = 'primary'; // Changed to primary for better consistency
            $roleLabel = 'Full-Time Staff';
            $icon = 'bi-briefcase';
            ?>
                    ...
                    <div class="mt-5 pt-4 border-top border-light">
                        <form method="POST" onsubmit="return confirmPasswordChange()">
                            ...
                            <div class="row g-4 align-items-end">
                                ...
                                <div class="col-md-4">
                                    <!-- Confirm Password nested slightly differently for layout -->
