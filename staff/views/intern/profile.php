                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <?php if (!empty($user['internship_months'])): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">
                                <span class="text-muted"><i class="bi bi-hourglass-split me-2"></i>Internship Duration</span>
                                <span class="fw-bold text-warning"><?= $user['internship_months'] ?> Months</span>
                            </li>
                        <?php endif; ?>
                ...
                <div class="card-body">
                    <form method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <!-- Interns usually don't have dependents for tax, removed as per request. -->
                        </div>
