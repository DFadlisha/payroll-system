...
<!-- Leave Balance Cards (Intern Specific) -->
        ...
        <div class="card border-info">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-1">Replacement Leave (NRL)</h6>
                        <h3 class="mb-0">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <small class="text-muted d-block">
                            <?= __('leaves.balance') ?>:
                            <?= ($leaveBalance['nrl']['total'] - $leaveBalance['nrl']['used']) ?>
                            <?= __('leaves.days') ?> (NRL)<br>
                            <?= __('leaves.balance') ?>:
                            <?= ($leaveBalance['medical']['total'] - $leaveBalance['medical']['used']) ?>
                            <?= __('leaves.days') ?> (<?= __('leaves.medical') ?>)
                        </small>
