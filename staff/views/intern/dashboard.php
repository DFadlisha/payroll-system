    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.1s">
            ...
            <div class="mt-2" style="font-size: 0.75rem;">
                <span class="text-success fw-bold">Training progress</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.2s">
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted small fw-bold text-uppercase">Project Status</span>
            </div>
            <h2 class="mb-0 fw-bold text-purple">Active</h2>
            <div class="mt-2" style="font-size: 0.75rem;">
                <span class="text-muted">Learning is key</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.3s">
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted small fw-bold text-uppercase">Training Days</span>
            </div>
            <h2 class="mb-0 fw-bold text-warning"><?= $attendanceStats['total_days'] ?? 0 ?></h2>
            <div class="mt-2" style="font-size: 0.75rem;">
    ...
    <div class="col-md-3">
        <div class="card glass-card border-0 p-4 h-100 animate-fade-in" style="animation-delay: 0.4s">
            <div class="d-flex align-items-center mb-3">
                ...
                <span class="text-muted small fw-bold text-uppercase">Allowance</span>
            </div>
