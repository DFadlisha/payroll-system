            ...
            <div class="card glass-card border-0 animate-fade-in h-100">
                ...
                <div class="card-header border-0 bg-transparent text-center py-5 position-relative overflow-hidden">
                    <div class="position-absolute top-0 start-0 w-100 h-100" 
                         style="background: linear-gradient(135deg, rgba(79, 70, 229, 0.1) 0%, rgba(124, 58, 237, 0.1) 100%); z-index: 0;"></div>
                    ...
                    <div class="position-relative z-1">
                        ...
                        <span class="badge bg-primary-soft text-primary rounded-pill px-4 py-2 border border-primary-subtle">
                ...
                <div class="card-body p-4">
                    <div class="d-flex flex-column gap-3">
                        <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white bg-opacity-50 border border-light">
                            <span class="text-muted small text-uppercase fw-bold"><i class="bi bi-building me-2 text-primary"></i>Company</span>
                            <span class="fw-semibold text-end text-dark"><?= htmlspecialchars($user['company_name'] ?? 'N/A') ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white bg-opacity-50 border border-light">
                            <span class="text-muted small text-uppercase fw-bold"><i class="bi bi-person-workspace me-2 text-primary"></i>Type</span>
                        ...
                        <?php if ($user['hourly_rate'] > 0): ?>
                            <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-primary bg-opacity-10 border border-primary-subtle">
                                <span class="text-muted small text-uppercase fw-bold"><i class="bi bi-coin me-2 text-primary"></i>Hourly Rate</span>
                                <span class="fw-bold text-primary fs-5"><?= formatMoney($user['hourly_rate']) ?><span class="fs-6 text-muted fw-normal">/hr</span></span>
                            </div>
                        <?php endif; ?>

                        <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white bg-opacity-50 border border-light">
                            <span class="text-muted small text-uppercase fw-bold"><i class="bi bi-cash me-2 text-primary"></i>Basic Salary</span>
                            <span class="fw-bold text-success font-monospace"><?= formatMoney($user['basic_salary']) ?></span>
                        </div>

                        <?php if (!empty($user['ic_number'])): ?>
                            <div class="d-flex justify-content-between align-items-center p-3 rounded-3 bg-white bg-opacity-50 border border-light">
                                <span class="text-muted small text-uppercase fw-bold"><i class="bi bi-card-heading me-2 text-primary"></i>IC No.</span>
        ...
        <div class="col-lg-8">
            <div class="card glass-card border-0 animate-fade-in" style="animation-delay: 0.1s;">
                <div class="card-header bg-transparent border-bottom border-light py-4 ps-4">
                    <h5 class="mb-0 fw-bold"><i class="bi bi-pencil-square me-2 text-primary"></i>Update Information</h5>
                </div>
                <div class="card-body p-4">
                    <form method="POST" class="needs-validation" novalidate>
                        <input type="hidden" name="action" value="update_profile">
                        <!-- Personal Info -->
                        <h6 class="text-primary text-uppercase small fw-bold mb-4 ps-1 border-start border-4 border-primary ps-2">Personal Information</h6>
                        <div class="row g-4 mb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text text-primary"><i class="bi bi-info-circle me-1"></i>Used for PCB Tax Calculation (Max: 10)</div>
                            </div>
                        </div>

                        <!-- Bank Info -->
                        <h6 class="text-primary text-uppercase small fw-bold mb-4 ps-1 border-start border-4 border-primary ps-2">Bank Information</h6>
                        <div class="row g-4 mb-5">
                            <div class="col-md-6">
